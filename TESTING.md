...
| --- | --- | --- | --- |
| style.css | [Jigsaw](https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2FCorentin-Vidick.github.io%2FP4-JSDogTraining) | ![screenshot](documentation/css-validation-style.png) | Pass: No Errors |
...
- As an API, using the "raw" URL appended to the linter URL.
    ...
    | --- | --- | --- | --- |
    | PP3 *run.py* file | `https://pep8ci.herokuapp.com/` | `https://raw.githubusercontent.com/Corentin-Vidick/p4-jsdogtraining/main/run.py` | https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Corentin-Vidick/p4-jsdogtraining/main/run.py |
    | Boutique Ado *settings.py* | `https://pep8ci.herokuapp.com/` | `https://raw.githubusercontent.com/Corentin-Vidick/p4-jsdogtraining/main/boutique_ado/settings.py` | https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Corentin-Vidick/p4-jsdogtraining/main/boutique_ado/settings.py |
...
| --- | --- | --- | --- |
| run.py | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Corentin-Vidick/p4-jsdogtraining/main/run.py) | ![screenshot](documentation/py-validation-run.png) | W291 trailing whitespace |
| settings.py | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Corentin-Vidick/p4-jsdogtraining/main/boutique-ado/settings.py) | ![screenshot](documentation/py-validation-settings.png) | E501 line too long |
| Blog views.py | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Corentin-Vidick/p4-jsdogtraining/main/blog/views.py) | ![screenshot](documentation/py-validation-blog-views.png) | Pass: No Errors |
| Checkout urls.py | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Corentin-Vidick/p4-jsdogtraining/main/checkout/urls.py) | ![screenshot](documentation/py-validation-checkout-urls.png) | W292 no newline at end of file |
| Profiles models.py | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/Corentin-Vidick/p4-jsdogtraining/main/profiles/models.py) | ![screenshot](documentation/py-validation-profiles-models.png) | Pass: No Errors |
...
Alternatively, use this link: https://github.com/Corentin-Vidick/P4-JSDogTraining/issues
...
Any remaining open issues can be tracked [here](https://github.com/Corentin-Vidick/P4-JSDogTraining/issues).

| Bug | Status |
| --- | --- |
| [JS `'let'` or `'const'` or `'template literal syntax'` or `'arrow function syntax (=>)'` is available in ES6 (use `'esversion: 11'`) or Mozilla JS extensions (use moz).](https://github.com/Corentin-Vidick/P4-JSDogTraining/issues/4) | Open |
| [Python `E501 line too long` (93 > 79 characters)](https://github.com/Corentin-Vidick/P4-JSDogTraining/issues/5) | Open |
